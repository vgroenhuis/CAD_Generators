...
try:
	...
	raise ImportError("Failed to import build_ring. Run main_menu.py, not this file directly.")
...
def _warn_direct_execution() -> None:
	os.error("ring_ui.py is not meant to be run directly. Please launch the application from main_menu.py.")

# We do not want to run this app directly, as it changes the directory from which the app is run.
if __name__ == "__main__":
	_warn_direct_execution()
